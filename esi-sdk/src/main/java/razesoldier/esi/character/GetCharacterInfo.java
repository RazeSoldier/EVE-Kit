...
public class GetCharacterInfo {
    ...
    @NotNull
    public CharacterInfo getInfo(@NotNull Integer id) throws ConnectionException, ParseException {
        final String endpoint = "https://esi.evetech.net/v4/characters/%d/?datasource=" + entryPoint;
        HttpRequest request = HttpRequest.newBuilder().uri(URI.create(String.format(endpoint, id))).build();
