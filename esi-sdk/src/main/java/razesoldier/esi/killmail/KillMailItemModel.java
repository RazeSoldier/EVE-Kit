...
public class KillMailItemModel {
    private Integer flag;
    private Integer item_type_id;
    private List<KillMailSubItemModel> items = new ArrayList<>();
    ...
    public List<KillMailSubItemModel> getItems() {
        return items;
    }

    public void setItems(List<KillMailSubItemModel> items) {
        this.items = items;
    }
